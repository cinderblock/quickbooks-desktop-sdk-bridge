...
ENTITIES: dict[str, EntityDef] = {
    "Account": EntityDef(
        "Account", "accounts",
        supports_add=True, supports_mod=True, supports_query=True, supports_delete=True,
    ...
    "Item": EntityDef(
        "Item", "items",
        supports_add=False, supports_mod=False, supports_query=True, supports_delete=False,
    ...
    "ItemNonInventory": EntityDef(
        "ItemNonInventory", "items/non-inventory",
        supports_add=True, supports_mod=True, supports_query=True, supports_delete=True,
    ...
    "Invoice": EntityDef(
        "Invoice", "invoices",
        supports_add=True, supports_mod=True, supports_query=True, supports_delete=True,
        is_transaction=True, id_field="TxnID",
    ...
    "PaymentMethod": EntityDef(
        ...
        supports_add=True, supports_mod=False, supports_query=True, supports_delete=True,
    ...
    "BillPaymentCheck": EntityDef(
        "BillPaymentCheck", "bill-payments",
        supports_add=True, supports_mod=False, supports_query=True, supports_delete=True,
        is_transaction=True, id_field="TxnID",
